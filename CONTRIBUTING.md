...
functionality you're adding in your contribution. Check out the [tests](https://github.com/tnn-gruntwork-io/terraform-google-static-assets/tree/master/test) folder for instructions on running the 
automated tests. 
...
code and release a new version, which you'll be able to find in the [releases page](https://github.com/tnn-gruntwork-io/terraform-google-static-assets/releases).
